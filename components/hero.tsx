  ...
  return (
    <section className="relative before:absolute before:h-[400px] before:container before:left-1/2 before:-translate-x-1/2 before:pointer-events-none before:z-[1] before:bg-header-gradient before:-top-nav-height">
      <div className="relative container pt-16 flex flex-col items-center">
        <Button variant="secondary" size="sm" className="animate-slide-down">
        ...
        <p className="relative text-accent max-w-2xl text-center text-base md:text-xl mb-12 animate-slide-down delay-200 before:absolute before:left-1/2 before:top-0 before:-translate-x-1/2 before:w-[70%] before:rounded-full before:shadow-hero">
